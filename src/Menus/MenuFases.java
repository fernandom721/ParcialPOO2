...
public class MenuFases {
    ...
    public void MenuFases(){
        ...
        Jugador jugador1 = new Jugador(raza, flag, flag, flag, contfases, contfases, flag, contfases, contfases, flag, flag);
        ValoresdelJugador j1 = new ValoresdelJugador(jugador1);
        Jugador jugador2 = new Jugador(raza, flag, flag, flag, contfases, contfases, flag, contfases, contfases, flag, flag);
        ...
        do{
            ...
            System.out.println(BLUE_FILL+"Jugador 1: "+jugador1.getRaza()+ANSI_RESET);
            ...
            switch (OpcionesJugador.getOpcion()){
                ...
                case 4:
                    ...
                    if(Edificiosj1.isEmpty()==true){
                        ...
                        for(int i=0;i<Edificiosj1.size();i++) {
                            System.out.println((i+1)+")"+Edificiosj1.get(i).getNombre());
                        }
                        int x = input.nextInt();
                        ...
                        int y = input.nextInt();
                        Edificiosj1.get(x-1).setHp(Edificiosj1.get(x-1).getHp()-TropasAtaque1.get(y-1).getDamage());
                        System.out.println(RED_FILL+"Atacando "+Edificiosj1.get(x-1).getNombre()+" enemigo"+ANSI_RESET);
                        if(Edificiosj1.get(x-1).getHp()<=0){
                            Edificiosj1.remove(x-1); 
                        }
                        //DEFENDERSE
            ...
            System.out.println(BLUE_FILL+"Jugador 2: "+jugador2.getRaza()+ANSI_RESET);
            System.out.println("Base Nivel: "+Basej2.getNivel());
            System.out.println("Salud de la Base: "+Basej2.getHp());
            System.out.println("Recursos Disponibles");
            System.out.println("Hierro: "+Basej2.getHierro());
            System.out.println("Cristales: "+Basej2.getCristales());
            System.out.println("Circuitos: "+Basej2.getCircuitos());
            int turnoj2 = input.nextInt();
            //if (Basej1.getHp()==0)
            if (turnoj2==0){
                System.out.println(GREEN_FILL+"GANADOR: Jugadpr 2: " + jugador2.getRaza() + ANSI_RESET);
